  ...
  <form class="left" action="prosespendaftaran.php" method="post">
    <div>
		...
		<div class="form-group">
			...
			<select name="tutor">
				<option value="O1A">Matematika-Tony Stark|-16:00-22:00</option>
				<option value="O2A">Matematika-Clint Barton|-16:00-22:00</option>
				...
				<option value="10B">Bahasa"0Indonesia-Groot|-15:00-21:00</option>
